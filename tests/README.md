...
O(rows x checks). At 124 falsifiability rows and a ~84s gate that is over two hours serially.
...
<https://bench.vedant.to>; `tests/evals/showcase/site/wrangler.toml`
