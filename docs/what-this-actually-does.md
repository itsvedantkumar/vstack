...
This is the closest thing this repository has to a stress test of the "47 checks, all
...
completion when the repository's own gate is red, and a gate of 47 checks with a documented, if
