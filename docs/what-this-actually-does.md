...
This is the closest thing this repository has to a stress test of the "46 checks, all
...
completion when the repository's own gate is red, and a gate of 46 checks with a documented, if
