...
Design-system sync deliberately uses no MCP: Claude Code's built-in DesignSync tool +
`/design-sync` cover claude.ai/design projects with zero config and zero listing cost.
