...
```bash
curl -fsSL https://raw.githubusercontent.com/itsvedantkumar/vstack/v1.63.0/bootstrap.sh -o bootstrap.sh
VSTACK_REF=v1.63.0 bash bootstrap.sh     # installs that tag, not main
```
