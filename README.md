...
| Mutations proving those checks can fail | none found | 40 |
...
`.claude/verify.sh` runs 40 checks. `tests/gate-falsifiability.sh` breaks the repository once per
