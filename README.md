...
```bash
curl -fsSL https://raw.githubusercontent.com/itsvedantkumar/vstack/v1.65.1/bootstrap.sh -o bootstrap.sh
VSTACK_REF=v1.65.1 bash bootstrap.sh     # installs that tag, not main
```
