...
| `.claude/verify.sh` | **this repository's own gate**, 52 checks; not shipped to anyone |
...
The gate is 52 checks (this number moves as checks are added; check 12 fails if this prose
