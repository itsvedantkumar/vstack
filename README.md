...
| Mutations proving those checks can fail | none found | 39 |
...
`.claude/verify.sh` runs 39 checks. `tests/gate-falsifiability.sh` breaks the repository once per
