...
runs on Opus 5 and Haiku 4.5, three arms, six fixtures with held-out checks the agent never sees.
...
| cost per task, Haiku 4.5 at 1.71.0 (paired n=20 and n=10) | baseline | 1.06x, 1.16x | 0.93x, 1.02x |
| wall time, Haiku 4.5 at 1.71.0 (register hook strikes cost Haiku extra turns) | baseline | 1.54x, 1.23x | 0.92x, 0.98x |
