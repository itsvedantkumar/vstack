...
The v1.25.0 audit found thirteen more, and they fall into four shapes worth naming:
...
```bash
curl -fsSL https://raw.githubusercontent.com/itsvedantkumar/vstack/v1.25.0/bootstrap.sh -o bootstrap.sh
less bootstrap.sh                        # about 100 lines
VSTACK_REF=v1.25.0 bash bootstrap.sh     # installs that tag, not main
```
