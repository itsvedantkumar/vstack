...
| `.claude/verify.sh` | **this repository's own gate**, 57 checks; not shipped to anyone |
...
The gate is 57 checks (this number moves as checks are added; check 12 fails if this prose
