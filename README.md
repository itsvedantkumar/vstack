...
The features above were put in front of a harness before they went on this page. Two hundred and ninety-six paid
runs on Opus 5 and Haiku 4.5, vstack against gstack and against pstack (the Claude Code port of
Cursor's pstack), six fixtures with held-out checks the agent never sees.
...
together. The full table, every fixture and every losing number included, is in RESULTS.md and on
the page.
