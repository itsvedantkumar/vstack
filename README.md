...
```bash
curl -fsSL https://raw.githubusercontent.com/itsvedantkumar/vstack/v1.52.0/bootstrap.sh -o bootstrap.sh
VSTACK_REF=v1.52.0 bash bootstrap.sh     # installs that tag, not main
```
